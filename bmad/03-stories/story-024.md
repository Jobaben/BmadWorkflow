...
- [ ] **Task 1**: Create PreparedContent interface (AC: 4)
  - [ ] Subtask 1.1: Create `src/async/types.ts` with PreparedContent
  - [ ] Subtask 1.2: Define stepId, snippets, annotations, preparedAt, expiresAt fields
  - [ ] Subtask 1.3: Export types from module

- [ ] **Task 2**: Create ContentBuffer class (AC: 1, 2, 3)
  - [ ] Subtask 2.1: Create `src/async/ContentBuffer.ts`
  - [ ] Subtask 2.2: Implement set(key, content) method
  - [ ] Subtask 2.3: Implement get(key) method (sync return)
  - [ ] Subtask 2.4: Implement has(key) method
  - [ ] Subtask 2.5: Implement delete(key) method
  - [ ] Subtask 2.6: Implement clear() method

- [ ] **Task 3**: Create async module exports (AC: 1)
  - [ ] Subtask 3.1: Create `src/async/index.ts`
  - [ ] Subtask 3.2: Export ContentBuffer and types

### Testing Tasks

- [ ] **Test Task 1**: Write unit tests for ContentBuffer CRUD operations
- [ ] **Test Task 2**: Verify synchronous access pattern
- [ ] **Test Task 3**: Test edge cases (missing keys, empty buffer)
